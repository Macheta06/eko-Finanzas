    ...
    <div className="flex flex-col gap-5 animate-slide-up">
      ...
      >
        <div className="surface-1 compact">
          ...
          <p
            className="mono"
            style={{ fontSize: '1.25rem', fontWeight: 700, marginTop: '4px' }}
          >
        ...
        <div className="surface-1 compact">
          ...
          >
            {totalExpenses > 0
              ? `${((sharedExpenses / totalExpenses) * 100).toFixed(0)}% del total`
              : '—'}
          </p>
        </div>
        <div className="surface-1 compact">
        ...
        >
          ...
          <div className="surface-1">
            ...
            >
              ...
              <span className="text-subheading" style={{ fontSize: '0.9rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            ...
            {proration.map((p, i) => (
              ...
              >
                ...
                >
                  {(p.proportional_percentage * 100).toFixed(1)}%
                </span>
                <span
                  className="mono"
                  style={{
                ...
                >
                  $
                  {p.assigned_amount.toLocaleString('es-CO', {
                    minimumFractionDigits: 0,
      ...
      {proration.length === 0 && (
        <div className="surface-1" style={{ textAlign: 'center' }}>
          <p className="text-secondary">
            Agrega integrantes y gastos para ver el cálculo de aportes aquí.
          </p>
        </div>
      )}
    </div>
